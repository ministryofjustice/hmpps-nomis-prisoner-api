...
data class SentenceAdjustmentResponse(
  ...
  val active: Boolean,
  @Schema(description = "Flag to indicate the adjustment is hidden from end users. This is true when it was create as part of a key date adjustment", required = true)
