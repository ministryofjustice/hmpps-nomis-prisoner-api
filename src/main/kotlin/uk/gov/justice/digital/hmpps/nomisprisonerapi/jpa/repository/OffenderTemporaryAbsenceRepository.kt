...
interface OffenderTemporaryAbsenceRepository : JpaRepository<OffenderTemporaryAbsence, OffenderExternalMovementId> {
  fun findAllByOffenderBooking_Offender_NomsId(offenderNo: String): List<OffenderTemporaryAbsence>
  fun findAllByOffenderBooking_BookingId(bookingId: Long): List<OffenderTemporaryAbsence>
