...
class IdentifyingMarksService(
  ...
  fun getIdentifyingMarks(bookingId: Long): BookingIdentifyingMarksResponse = bookingRepository.findByIdOrNull(bookingId)
    ?.let { booking ->
  ...
  fun getIdentifyingMarksImageDetails(imageId: Long): IdentifyingMarkImageDetailsResponse = imageRepository.findByIdOrNull(imageId)
    ?.let {
  ...
  fun getIdentifyingMarksImageData(imageId: Long): ByteArray = imageRepository.findByIdOrNull(imageId)
