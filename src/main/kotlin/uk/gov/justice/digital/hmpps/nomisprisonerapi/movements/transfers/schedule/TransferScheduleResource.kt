...
class TransferScheduleResource(
  ...
  @PutMapping("/out")
  @Operation(
    summary = "Inserts or updates a transfer schedule out and waitlist for an offender",
    description = "Creates or updates a transfer schedule out on the prisoner's latest booking. Requires ROLE_NOMIS_PRISONER_API__SYNCHRONISATION__RW",
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "Transfer schedule out created or updated",
      ),
      ApiResponse(
        responseCode = "400",
