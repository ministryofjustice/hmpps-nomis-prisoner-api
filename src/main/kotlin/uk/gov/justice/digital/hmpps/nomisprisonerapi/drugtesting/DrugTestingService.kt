...
class DrugTestingService(
  ...
  fun findRandomTestingProgramWithPrisoners(rtpId: Long): List<RandomTestingProgramDto> = randomTestingProgramRepository.findRandomTestingProgramWithOffenders(rtpId).ifEmpty {
    throw NotFoundException("Random testing program with id $rtpId not found")
  }
}
