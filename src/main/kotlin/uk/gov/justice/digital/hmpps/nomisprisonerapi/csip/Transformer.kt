...
private fun CSIPReport.toReportDetailResponse() = ReportDetails(
...
fun CSIPFactor.toFactorResponse() = CSIPFactorResponse(
  id = id,
  type = type.toCodeDescription(),
  comment = comment,
  createDateTime = createDatetime,
...
private fun CSIPReport.toInvestigationResponse() = InvestigationDetails(
...
private fun CSIPInterview.toInterviewResponse() = InterviewDetails(
  id = id,
...
private fun CSIPReport.toDecisionResponse() = Decision(
...
private fun CSIPReport.toActionsResponse() = Actions(
...
private fun CSIPPlan.toPlanResponse() = Plan(
  id = id,
...
private fun CSIPReview.toReviewResponse() = Review(
  id = id,
...
private fun CSIPAttendee.toAttendeeResponse() = Attendee(
  id = id,
  name = name,
  role = role,
  attended = attended,
