...
(
    ...
    FOLLOW_UP_DATE                DATE,
    CONSTRAINT INC_CASE_STAFF_FK FOREIGN KEY (REPORTED_STAFF_ID) REFERENCES STAFF_MEMBERS (STAFF_ID),
    CONSTRAINT INC_CASE_INC_STS_FK FOREIGN KEY (INCIDENT_STATUS) REFERENCES INCIDENT_STATUSES (CODE),
    CONSTRAINT INC_CASE_AGY_LOC_FK FOREIGN KEY (AGY_LOC_ID) REFERENCES AGENCY_LOCATIONS (AGY_LOC_ID),
    CONSTRAINT INC_CASE_QUE_FK FOREIGN KEY (QUESTIONNAIRE_ID) REFERENCES QUESTIONNAIRES (QUESTIONNAIRE_ID)
);
