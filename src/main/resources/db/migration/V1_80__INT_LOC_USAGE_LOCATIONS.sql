...
(   INTERNAL_LOCATION_USAGE_ID    NUMBER(10)                             NOT NULL, 
    ...
    LIST_SEQ                      NUMBER(6), 
    USAGE_LOCATION_ID             NUMBER(10)                             NOT NULL CONSTRAINT INT_LOC_USAGE_LOCATIONS_PK PRIMARY KEY,
    ...
    constraint ILOC_USG_LOC_ILOC_USG_LOC_FK foreign key (PARENT_USAGE_LOCATION_ID) references INT_LOC_USAGE_LOCATIONS (USAGE_LOCATION_ID),
    constraint INT_LOC_USG_LOC_INT_LOC_USG_FK foreign key (INTERNAL_LOCATION_USAGE_ID) references INTERNAL_LOCATION_USAGES (INTERNAL_LOCATION_USAGE_ID)
);
