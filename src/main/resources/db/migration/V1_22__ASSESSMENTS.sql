...
CREATE INDEX "ASSESSMENTS_NI1" ON "ASSESSMENTS" ("PARENT_ASSESSMENT_ID");
CREATE INDEX "ASSESSMENTS_NI2" ON "ASSESSMENTS" ("DESCRIPTION");
CREATE INDEX "ASSESSMENTS_NI3" ON "ASSESSMENTS" ("ASSESSMENT_CLASS", "ASSESSMENT_CODE");
