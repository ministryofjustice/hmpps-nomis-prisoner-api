CREATE TABLE OFFENDER_CASE_NOTES (
  ...
  CONSTRAINT OFF_CN_OFF_BKG_FK FOREIGN KEY (OFFENDER_BOOK_ID) REFERENCES OFFENDER_BOOKINGS (OFFENDER_BOOK_ID),
  CONSTRAINT OFF_CN_STF_FK FOREIGN KEY (STAFF_ID) REFERENCES STAFF_MEMBERS (STAFF_ID)
);
...
CREATE INDEX OFFENDER_CASE_NOTES_X01 ON OFFENDER_CASE_NOTES (OFFENDER_BOOK_ID, CONTACT_DATE);
CREATE INDEX OFFENDER_CASE_NOTES_X02 ON OFFENDER_CASE_NOTES (EVENT_ID, CASE_NOTE_ID);
CREATE INDEX OFFENDER_CASE_NOTES_X04 ON OFFENDER_CASE_NOTES (AUDIT_TIMESTAMP, CASE_NOTE_TYPE, CASE_NOTE_SUB_TYPE);
CREATE INDEX OFFENDER_CASE_NOTES_X05 ON OFFENDER_CASE_NOTES (AGY_LOC_ID, OFFENDER_BOOK_ID);
