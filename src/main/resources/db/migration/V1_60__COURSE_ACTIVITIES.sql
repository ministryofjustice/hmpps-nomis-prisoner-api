...
CREATE TRIGGER COURSE_ACTIVITY_AREA_GENERATE AFTER INSERT ON "COURSE_ACTIVITIES" FOR EACH ROW CALL "uk.gov.justice.digital.hmpps.nomisprisonerapi.jpa.helper.CourseActivityTrigger";