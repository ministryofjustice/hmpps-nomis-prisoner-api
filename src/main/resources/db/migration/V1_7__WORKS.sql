...
COMMENT ON COLUMN "WORKS"."MANUAL_CLOSE_FLAG" IS 'Flag to control whether to close the job automatically or not';
...
COMMENT ON COLUMN "WORKS"."MANUAL_SELECT_FLAG" IS '? If it is manual select for Case notes';
...
CREATE INDEX "WORKS_X01" ON "WORKS" ("CASELOAD_TYPE", "WORKFLOW_TYPE");
