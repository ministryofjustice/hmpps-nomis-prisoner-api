  ...
  inner class GL {
    ...
    fun getGLTransaction() {
      webTestClient.get().uri("/transactions/${transaction1.transactionId}/general-ledger")
        ...
        .jsonPath("$[0].transactionTimestamp").isEqualTo(glTransaction1.getTransactionEntryDateAndTime())
        ...
        .jsonPath("$[1].transactionTimestamp").isEqualTo(glTransaction2.getTransactionEntryDateAndTime())
