  ...
  inner class GetTemporaryAbsencesAndMovements {
    ...
    fun `should retrieve agency address`() {
      ...
      webTestClient.get()
        ...
        .jsonPath("$.bookings[0].temporaryAbsenceApplications[0].absences[0].scheduledTemporaryAbsence.toFullAddress").isEqualTo("2, Gloucester Terrace, Stanningley Road, 29059, W.YORKSHIRE, ENG")
    ...
    fun `should retrieve agency address from external movement`() {
      ...
      webTestClient.get()
        ...
        .jsonPath("$.bookings[0].temporaryAbsenceApplications[0].absences[0].temporaryAbsence.toFullAddress").isEqualTo("2, Gloucester Terrace, Stanningley Road, 29059, W.YORKSHIRE, ENG")
    ...
    fun `should retrieve agency address from return movement`() {
      ...
      webTestClient.get()
        ...
        .jsonPath("$.bookings[0].temporaryAbsenceApplications[0].absences[0].temporaryAbsenceReturn.fromFullAddress").isEqualTo("2, Gloucester Terrace, Stanningley Road, 29059, W.YORKSHIRE, ENG")
    ...
    fun `should format address`() {
      ...
      webTestClient.get()
        ...
        .expectBody()
        .jsonPath("$.bookings[0].temporaryAbsenceApplications[0].absences[0].scheduledTemporaryAbsence.toAddressDescription").isEqualTo("Boots")
        .jsonPath("$.bookings[0].temporaryAbsenceApplications[0].absences[0].scheduledTemporaryAbsence.toFullAddress").isEqualTo("High Street, Sheffield, ENG")
        .jsonPath("$.bookings[0].temporaryAbsenceApplications[0].absences[0].scheduledTemporaryAbsence.toAddressPostcode").isEqualTo("S2 2AA")
    }
    ...
    fun `should format address with whitespace instead of postcode`() {
      ...
      webTestClient.get()
        ...
        .expectBody()
        .jsonPath("$.bookings[0].temporaryAbsenceApplications[0].absences[0].scheduledTemporaryAbsence.toAddressDescription").isEqualTo("Boots")
        .jsonPath("$.bookings[0].temporaryAbsenceApplications[0].absences[0].scheduledTemporaryAbsence.toFullAddress").isEqualTo("41, High Street, Sheffield, ENG")
      ...
      fun `should retrieve corporate address`() {
        webTestClient.get()
          ...
          .apply {
            ...
            assertThat(toFullAddress).isEqualTo("Brown Court, Scotland Street, Hunters Bar, 25343, S.YORKSHIRE, ENG")
      ...
      fun `should retrieve agency address`() {
        webTestClient.get()
          ...
          .apply {
            ...
            assertThat(toFullAddress).isEqualTo("2, Herries Road, Stanningley Road, 25343, S.YORKSHIRE, ENG")
          ...
          fun `should retrieve address from scheduled temporary absence`() {
            webTestClient.get()
              ...
              .apply {
                ...
                assertThat(toAddressId).isEqualTo(offenderAddress.addressId)
                assertThat(toAddressOwnerClass).isEqualTo(offenderAddress.addressOwnerClass)
                assertThat(toFullAddress).isEqualTo("Flat 1, 41, High Street, Hillsborough, 25343, S.YORKSHIRE, ENG")
          ...
          fun `should take corporate address from schedule`() {
            webTestClient.get()
              ...
              .apply {
                ...
                assertThat(toAddressOwnerClass).isEqualTo("CORP")
                assertThat(toAddressDescription).isEqualTo("Boots")
                assertThat(toFullAddress).isEqualTo("3B, Brown Court, Scotland Street, Hunters Bar, 25343, S.YORKSHIRE, ENG")
                assertThat(toAddressPostcode).isEqualTo("S1 3GG")
              }
          }
        }
          ...
          fun `should retrieve address from scheduled OUT`() {
            webTestClient.get()
              ...
              .apply {
                ...
                assertThat(fromFullAddress).isEqualTo("Flat 1, 41, High Street, Hillsborough, 25343, S.YORKSHIRE, ENG")
          ...
          fun `should retrieve corporate address from scheduled OUT`() {
            webTestClient.get()
              ...
              .apply {
                ...
                assertThat(fromFullAddress).isEqualTo("3B, Brown Court, Scotland Street, Hunters Bar, 25343, S.YORKSHIRE, ENG")
          ...
          fun `should retrieve address from scheduled OUT`() {
            webTestClient.get()
              ...
              .apply {
                ...
                assertThat(fromFullAddress).isEqualTo("2, Herries Road, Stanningley Road, 25343, S.YORKSHIRE, ENG")
